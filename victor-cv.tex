...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
  % \item \small At the moment, I have passed 212 ECTS and I am enrolled for 30 ECTS, including an Internship and the Bachelor's Thesis.
  \item \small Current GPA: 9.33 / 10.00
  \item \small Honors: 174 / 240 ETCS
  \item \small Final bachelor's project (supervised by \href{http://www.gsd.uab.es/people?controller=member&view=member&id=9&slug=josep-maria}{\graydotuline{J.M. Mondelo}}): \textit{Numerical propagation of trajectories of Earth-orbiting spacecraft} (grade: 00.00 / 10.00).
\end{itemize}
\resumeHeadingListEnd{}
