...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
  ...
  \item \small Final master's project (supervised by \href{https://www.phys.ens.fr/~alexakis/}{\graydotuline{Alexandros Alexakis}} and \href{https://www.math.ens.psl.eu/~dormy/}{\graydotuline{Emmanuel Dormy}}): \textit{Turbulence transition from 2D to 3D} (in progress).
\end{itemize}
