...
\begin{center}
	...
	\href{tel:+447584683859}{\faPhone \ \graydotuline{+44 7584683859}} \ $|$ \ % row = 2, col = 1 
	\href{mailto:victor.ballester-ribo@dauphine.eu}{\faEnvelope \ \graydotuline{v.ballester-ribo24@imperial.ac.uk}} \ $|$ \ % row = 2, col = 1
	\href{https://maps.app.goo.gl/PT7TCM7RE38BCuMS8}{\faHome \ \graydotuline{London}} \\[1.5pc] % row = 2, col = 1
\end{center}
%-------------------------------------------

%-----------------DESCRIPTION-------------------
\begin{justify}
	I am a PhD student in the Department of Astronautics at Imperial College of London. I graduated in 2023 in Mathematics at Autonomous University of Bar\-ce\-lo\-na and next year I moved to Paris to pursue a master degree at Dauphine-PSL University in Applied and Theoretical Mathematics. My main interests are in the field of Computational Mathematics and PDEs. Specifically, I am particularly interested in the application of Mathematics to Fluid Dynamics.
\end{justify}
...
\resumeQuadHeading{PhD in Aeronautics}{October 2024 - Present}
{Imperial College of London}{London, UK}
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	\item \small Research on how gaps in aircraft wings affect the transition to turbulence.
	\item \small Working with \href{https://www.nektar.info/}{Nektar++} software on incompressible and compressible flows.
	\item \small Supervised by \href{https://www.imperial.ac.uk/people/s.sherwin}{\graydotuline{Spencer Sherwin}} and \href{https://www.imperial.ac.uk/people/y.hwang}{\graydotuline{Yongyun Hwang}}.
\end{itemize}

\resumeHeadingListEnd{}\resumeHeadingListStart{}
\resumeQuadHeading{M2 in Applied and Theoretical Mathematics}{September 2023 - July 2024}
{Dauphine - PSL University}{Paris, France}
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	\item \small GPA: 16.54 / 20.00
	\item \small Minor in Physics, specifically in Computational Fluid Dynamics.
	\item \small Final master's project (supervised by \href{https://www.phys.ens.fr/~alexakis/}{\graydotuline{Alexandros Alexakis}} and \href{https://www.math.ens.psl.eu/~dormy/}{\graydotuline{Emmanuel Dormy}}): \textit{2D turbulence spreading}.
\end{itemize}
...
\resumeHeadingListStart{}
\resumeQuadHeading{Trail Maintainer}{August 11 - August 31, 2024}{}{Thórsmörk, Iceland}
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
\item \small I volunteered together in a group of 12 people in Thórsmörk region in Iceland doing duties such as: changing timbers that serve as steps, redirecting parts of paths, eliminating small scree slopes, adding drains, widening paths or planting trees.
\resumeHeadingListEnd{}
...
\resumeHeadingListStart{}
\resumeQuadHeading{2D turbulence spreading}{February 2024 - July 2024}{Fluid dynamics, Turbulence, HPC, C, C++}{\href{https://github.com/victorballester7/final-master-thesis/blob/main/latex/main.pdf}{\faFileTextO \ \graydotuline{Report}} \ $|$ \ \href{https://www.math.ens.psl.eu/~dormy/}{\faGithub \ \graydotuline{Code}}}
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	\item \small Simulation of 2D Navier-Stokes equations with a pseudo-spectral method in order to study the spreading of turbulence in a 2D fluid.
	\item \small Final Masterr thesis of the Applied Mathematics's degree at Paris-Dauphine University.
	\item Grade: 18.00 / 20.00
	\item \small Advised by \href{https://www.phys.ens.fr/~alexakis/}{\graydotuline{Alexandros Alexakis}} and \href{}{\graydotuline{Emmanuel Dormy}}.
\end{itemize}
\resumeHeadingListEnd{}
...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	...
	\item \small Co-authored with \href{https://www.linkedin.com/in/jona-nägerl-3910a5243/}{\graydotuline{Jona Nägerl}}.
\end{itemize}
\resumeHeadingListEnd{}
...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	...
	\item \small Advised by \href{https://blog.espci.fr/laurette/}{\graydotuline{Laurette Tuckerman}}.
\end{itemize}
\resumeHeadingListEnd{}
...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	...
	\item \small Project conducted as part of the course \textit{Workshop in Mathematical Modelling} at the Autonomous University of Barcelona, co-authored with \href{https://github.com/Oriolbosg}{\graydotuline{Oriol Bosquet}} and \href{https://github.com/carlosala}{\graydotuline{Carlo Sala}}.
...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
	...
	\item \small Project developed as part of the course \textit{Discrete Mathematics} at the Autonomous University of Barcelona, co-authored with \href{https://github.com/Oriolbosg}{\graydotuline{Oriol Bosquet}}, Eric Recio and \href{https://github.com/carlosala}{\graydotuline{Carlo Sala}}.
\end{itemize}
\resumeItemListEnd{}
