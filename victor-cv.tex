...
\begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
  \item \small Current GPA: 15.50 / 20.00
...
\section{Skills}
\resumeHeadingListStart{}
\resumeSectionTypeOne{Industry\hspace{1cm} knowledge}{Programming \ $|$ \ Mathematical Modeling \ $|$ \ Numerical Analysis \ $|$ \ \hspace{2cm} Computational Mathematics  \ $|$ \ CFD \ $|$ \ FFT}
\resumeHeadingListEnd{}
